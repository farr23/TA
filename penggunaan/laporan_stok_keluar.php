...
$title = "Laporan Stok Keluar - Cafe Qita";
...
$sql = "SELECT * FROM tb_transaksi_bahan WHERE jenis_transaksi = 'Keluar'";
...
$sql_count = "SELECT COUNT(*) as total FROM tb_transaksi_bahan WHERE jenis_transaksi = 'Keluar'";
if ($start_date && $end_date) {
    ...
    <div class="container-fluid">
        ...
        <div class="card mb-4">
            <div class="card-header">
                <h5>Detail Transaksi Stok Keluar</h5>
            </div>
            <div class="card-body">
                ...
                <?php else: ?>
                    <p>Data stok keluar tidak ditemukan.</p>
                <?php endif; ?>
            </div>
        </div>
