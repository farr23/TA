...
$title = "Tambah Supplier - Cafe Qita";
    ...
    <div class="container-fluid">
        <div class="card">
            ...
            <div class="card-header">
                <h3 class="card-title"><i class="fas fa-plus text-sm mr-2"></i> Tambah Supplier</h3>
                ...
                <div class="row">
                    ...
                    ?>
                        <div class="form-group">
                            ...
                            <input type="text" name="nm_supplier" class="form-control" id="nm_supplier" placeholder="nama supplier" autofocus autocomplete="off" required>
                        </div>
                        <div class="form-group">
                            <label for="telp">No Telepon</label>
                            <input type="text" name="telp" class="form-control" id="telp" placeholder="nomor telepon supplier" pattern="[0-9]{5,}" title="minimal 5 angka" required>
                        </div>
                        <div class="form-group">
                            <label for="deskripsi">Deskripsi</label>
                            <textarea name="deskripsi" id="deskripsi" rows="2" class="form-control" placeholder="Deskripsi supplier" required></textarea>
                        </div>
                        <div class="form-group">
